            ...
            GC: GenderClaim,
        {
                ...
                V: MapAccess<'de>,
            {
                deserialize_fields! {
                    map {
                        [sub]
                        [Option(LanguageTag(name))]
                        [Option(LanguageTag(given_name))]
                        [Option(LanguageTag(family_name))]
                        [Option(LanguageTag(middle_name))]
                        [Option(LanguageTag(nickname))]
                        [Option(preferred_username)]
                        [Option(LanguageTag(profile))]
                        [Option(LanguageTag(picture))]
                        [Option(LanguageTag(website))]
                        [Option(email)]
